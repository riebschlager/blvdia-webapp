...
<div class="container" ng-app="Admin" ng-controller="AdminCtrl">
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <img class="img-responsive" ng-if="previewSrc[0] == ''" src="http://placehold.it/640x480&amp;text=BLVDIA" alt="">
        ...
        <div class="col-sm-4">
            ...
            <img class="img-responsive" ng-if="previewSrc[1] == ''" src="http://placehold.it/640x480&amp;text=BLVDIA" alt="">
            <div style="margin-top: 0.5em;">
        ...
        <div class="col-sm-4">
            ...
            <img class="img-responsive" ng-if="previewSrc[2] == ''" src="http://placehold.it/640x480&amp;text=BLVDIA" alt="">
            <div style="margin-top: 0.5em;">
        ...
        <div class="col-sm-4">
            ...
            <img class="img-responsive" ng-if="previewSrc[3] == ''" src="http://placehold.it/640x480&amp;text=BLVDIA" alt="">
            <div style="margin-top: 0.5em;">
        ...
        <div class="col-sm-4">
            ...
            <img class="img-responsive" ng-if="previewSrc[4] == ''" src="http://placehold.it/640x480&amp;text=BLVDIA" alt="">
            <div style="margin-top: 0.5em;">
        ...
        <div class="col-sm-4">
            ...
            <img class="img-responsive" ng-if="previewSrc[5] == ''" src="http://placehold.it/640x480&amp;text=BLVDIA" alt="">
            <div style="margin-top: 0.5em;">
