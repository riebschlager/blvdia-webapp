        ...
        <div class="col-xs-12 col-sm-6 col-sm-offset-3" ng-if="!first">
            ...
            <div class="row">
                <div class="col-xs-4">
                    ...
                    ng-href="https://www.facebook.com/sharer/sharer.php?u={{url('/')}}/photo/{{$photo->uid}}" class="btn btn-primary btn-block margin-top"><img width="30" height="30" src="/img/icon-facebook.png" alt=""></a>
                </div>
                <div class="col-xs-4">
